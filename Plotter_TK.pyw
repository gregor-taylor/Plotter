...
class StartPage(ttk.Frame):
    def __init__(self, parent, controller): 
        ...
        self.canvas.get_tk_widget().pack(side="bottom", fill="both", expand = True, pady=5)
    ...
    def plot_it(self, controller):
        if controller.Filename == '':
            ...
            for i in controller.Y_index_list:
                self.sp1_1.plot(controller.plot_arrays_dict[controller.X_index], controller.plot_arrays_dict[i], 'o')
            ...
            if controller.Y2_index_list != []:
                ...
                for i in controller.Y2_index_list:
                    self.sp1_2.plot(controller.plot_arrays_dict[controller.X_index], controller.plot_arrays_dict[i], 'o')
